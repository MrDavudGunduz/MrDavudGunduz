...
**Software Engineer | Spatial Computing | Apple Ecosystem**

Software Engineer focused on pushing the boundaries of Spatial Computing, on-device Artificial Intelligence, and high-performance system architectures within the Apple ecosystem. Dedicated to engineering scalable, clean-code solutions for iOS, macOS, and visionOS. 

My development philosophy is anchored in **modular architecture**, **strict thread safety (Swift 6 Concurrency)**, and **rigorous performance optimization**. I do not just build software; I engineer spatial experiences that bridge the digital and physical worlds fluidly and securely.

---

### 🧠 Core Engineering Philosophy

*   **Architectural Excellence:** Dedicated to Modular Targets, Type-Safe Dependency Injection, and strict adherence to Clean Code and SwiftLint standards.
*   **Performance & Concurrency:** Leveraging Swift 6 actor-isolated pipelines to eliminate data races and ensure absolute thread safety in complex, highly concurrent environments.
*   **Privacy & Security:** Implementing persistent, secure data management protocols, including end-to-end AES-GCM encryption for sensitive on-device context.
*   **Spatial User Experience:** Crafting volumetric interfaces utilizing advanced physics dynamics, genuine glassmorphism, and seamless Z-axis depth integration.
...
| **Apple Ecosystem** | SwiftUI, RealityKit, ARKit, SwiftData |
| **Cross-Platform** | Flutter |
| **AI & Machine Learning** | MLX (On-device AI integration) |
| **Architecture & Tooling** | Swift 6 Concurrency, Modular Design, Xcode, Git |
...
*   **Web3 & Spatial Verification:** Ideating proof-of-concept solutions for blockchain-based spatial verification ahead of **ETHGlobal Lisbon 2026** (July 2026).
*   **Hardware-Software Synergy:** Bridging the gap between academic studies in microprocessors and practical, high-performance software integration.

---

### 📫 Connect

Open to technical collaborations, open-source discussions, and exploring the future of spatial computing.

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/davud-g%C3%BCnd%C3%BCz-9949622a0/)
[![X](https://img.shields.io/badge/X-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/DavudGunduz01)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mr.davud.gunduz@gmail.com)
